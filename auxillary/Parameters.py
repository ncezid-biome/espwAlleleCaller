...
class Parameters():
    ...
    def parseArgs() -> Parameters:
        ...
        def printHelp():
            ...
            EOL = "\n"
            SEP = ", "
            MSG = "determines the allele of espW from genomic sequence data" + EOL + \
                   ...
                   GAP + f"{CLEANUP_FLAGS[0] + SEP + CLEANUP_FLAGS[1]:<21}{'save intermediate files generated by this program'}" + EOL + \
